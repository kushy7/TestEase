...
curl -X POST -H "Authorization: token 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" -H "Content-Type: application/zip" --data-binary @publish.zip "https://github.ncsu.edu/api/uploads/repos/engr-csc-sdc/2024SpringTeam31-Hitachi-2/releases/2160/assets?name=publish.zip"
